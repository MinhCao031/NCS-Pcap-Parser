 ...
 */
static gboolean
parse_port_pasv(const u_char *line, int linelen, guint32 *ftp_ip, guint16 *ftp_port,
...
static gboolean
isvalid_rfc2428_delimiter(const u_char c)
{
 ...
 */
static gboolean
parse_eprt_request(const u_char* line, gint linelen, guint32 *eprt_af,
 ...
 */
static gboolean
parse_extended_pasv_response(const u_char *line, gint linelen, guint16 *ftp_port,
